...
import { useParams } from 'next/navigation'; // ✅ useParams instead of useSearchParams
...
export default function PointsTransactionsList() {
  const dispatch = useDispatch();
  const { farmerId } = useParams(); // ✅ dynamic param from URL
