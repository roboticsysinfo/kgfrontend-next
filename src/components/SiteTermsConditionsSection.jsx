...
const SiteTermsConditionsSection = () => {
            ...
            <div className='row'>
                <div className='col-lg-12 col-xs-12 col-sm-12'>
                    ...
                    <p>
                        ...
                        <div className="page_content" dangerouslySetInnerHTML={{ __html: siteDetails?.termsAndConditions || "No content available" }} />
...
export default SiteTermsConditionsSection